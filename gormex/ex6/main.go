...
func main() {
	db, err = gorm.Open("mysql", "root:000000@tcp(192.168.204.128:3306)/ex6?charset=utf8mb4&parseTime=True&loc=Local")
	if err != nil {
	...
	db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户表'").AutoMigrate(&Tb_UserBase{})
	db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='职业表'").AutoMigrate(&Tb_Carrer{})
	db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='喜欢人员列表'").AutoMigrate(&Tb_Favorite{})
	db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='黑名单表'").AutoMigrate(&Tb_Black{})
	db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='相册表'").AutoMigrate(&Tb_PhotoAlbum{})
	//------------------------------------------------------------_
	var l1 = Tb_Carrer{}
	l1.CarrerName = "ca111"
	db.Create(&l1)
